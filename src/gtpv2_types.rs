...
pub static GTPV2_IE_TYPES: [(&str, bool, u32);256] = [
/* 0 */		("Reserved", false, 0),
/* 1 */		("International Mobile Subscriber Identity (IMSI)", false, 0),
/* 2 */		("Cause", false, 0),
/* 3 */		("Recovery (Restart Counter)", false, 0),
/* 4 */		("Unknown", false, 0),
/* 5 */		("Unknown", false, 0),
/* 6 */		("Unknown", false, 0),
/* 7 */		("Unknown", false, 0),
...
/* 69 */	("Unknown", false, 0),
/* 70 */	("Unknown", false, 0),
/* 71 */	("Access Point Name (APN)", false, 0),
/* 72 */	("Aggregate Maximum Bit Rate (AMBR)", false, 0),
/* 73 */	("EPS Bearer ID (EBI)", false, 0),
/* 74 */	("IP Address", false, 0),
/* 75 */	("Mobile Equipment Identity (MEI)", false, 0),
/* 76 */	("MSISDN", false, 0),
/* 77 */	("Indication", false, 0),
/* 78 */	("Protocol Configuration Options (PCO)", false, 0),
/* 79 */	("PDN Address Allocation (PAA)", false, 0),
/* 80 */	("Bearer Level Quality of Service (Bearer QoS)", false, 0),
/* 81 */	("Flow Quality of Service (Flow QoS)", false, 0),
/* 82 */	("RAT Type", false, 0),
/* 83 */	("Serving Network", false, 0),
/* 84 */	("EPS Bearer Level Traffic Flow Template (Bearer TFT)", false, 0),
/* 85 */	("Traffic Aggregation Description (TAD)", false, 0),
/* 86 */	("User Location Information (ULI)", false, 0),
/* 87 */	("Fully Qualified Tunnel Endpoint Identifier (F-TEID)", false, 0),
/* 88 */	("TMSI", false, 0),
/* 89 */	("Global CN-Id", false, 0),
/* 90 */	("S103 PDN Data Forwarding Info (S103PDF)", false, 0),
/* 91 */	("S1-U Data Forwarding Info (S1UDF)", false, 0),
/* 92 */	("Delay Value", false, 0),
/* 93 */	("Bearer Context ", false, 0),
/* 94 */	("Charging ID", false, 0),
/* 95 */	("Charging Characteristics", false, 0),
/* 96 */	("Trace Information", false, 0),
/* 97 */	("Bearer Flags", false, 0),
/* 98 */	("Reserved", false, 0),
/* 99 */	("PDN Type", false, 0),
/* 100 */	("Procedure Transaction ID", false, 0),
/* 101 */	("Reserved", false, 0),
/* 102 */	("Reserved", false, 0),
/* 103 */	("MM Context (GSM Key and Triplets)", false, 0),
/* 104 */	("MM Context (UMTS Key, Used Cipher and Quintuplets)", false, 0),
/* 105 */	("MM Context (GSM Key, Used Cipher and Quintuplets)", false, 0),
/* 106 */	("MM Context (UMTS Key and Quintuplets)", false, 0),
/* 107 */	("MM Context (EPS Security Context, Quadruplets and Quintuplets)", false, 0),
/* 108 */	("MM Context (UMTS Key, Quadruplets and Quintuplets)", false, 0),
/* 109 */	("PDN Connection", false, 0),
/* 110 */	("PDU Numbers", false, 0),
/* 111 */	("P-TMSI", false, 0),
/* 112 */	("P-TMSI Signature", false, 0),
/* 113 */	("Hop Counter", false, 0),
/* 114 */	("UE Time Zone", false, 0),
/* 115 */	("Trace Reference", false, 0),
/* 116 */	("Complete Request Message", false, 0),
/* 117 */	("GUTI", false, 0),
/* 118 */	("F-Container", false, 0),
/* 119 */	("F-Cause", false, 0),
/* 120 */	("PLMN ID", false, 0),
/* 121 */	("Target Identification", false, 0),
/* 122 */	("Reserved ", false, 0),
/* 123 */	("Packet Flow ID ", false, 0),
/* 124 */	("RAB Context ", false, 0),
/* 125 */	("Source RNC PDCP Context Info", false, 0),
/* 126 */	("Port Number", false, 0),
/* 127 */	("APN Restriction", false, 0),
/* 128 */	("Selection Mode", false, 0),
/* 129 */	("Source Identification", false, 0),
/* 130 */	("Reserved", false, 0),
/* 131 */	("Change Reporting Action", false, 0),
/* 132 */	("Fully Qualified PDN Connection Set Identifier (FQ-CSID)", false, 0),
/* 133 */	("Channel needed", false, 0),
/* 134 */	("eMLPP Priority", false, 0),
/* 135 */	("Node Type", false, 0),
/* 136 */	("Fully Qualified Domain Name (FQDN)", false, 0),
/* 137 */	("Transaction Identifier (TI)", false, 0),
/* 138 */	("MBMS Session Duration", false, 0),
/* 139 */	("MBMS Service Area", false, 0),
/* 140 */	("MBMS Session Identifier", false, 0),
/* 141 */	("MBMS Flow Identifier", false, 0),
/* 142 */	("MBMS IP Multicast Distribution", false, 0),
/* 143 */	("MBMS Distribution Acknowledge", false, 0),
/* 144 */	("RFSP Index", false, 0),
/* 145 */	("User CSG Information (UCI)", false, 0),
/* 146 */	("CSG Information Reporting Action", false, 0),
/* 147 */	("CSG ID", false, 0),
/* 148 */	("CSG Membership Indication (CMI)", false, 0),
/* 149 */	("Service indicator", false, 0),
/* 150 */	("Detach Type", false, 0),
/* 151 */	("Local Distiguished Name (LDN)", false, 0),
/* 152 */	("Node Features", false, 0),
/* 153 */	("MBMS Time to Data Transfer", false, 0),
/* 154 */	("Throttling", false, 0),
/* 155 */	("Allocation/Retention Priority (ARP)", false, 0),
/* 156 */	("EPC Timer", false, 0),
/* 157 */	("Signalling Priority Indication", false, 0),
/* 158 */	("Temporary Mobile Group Identity (TMGI)", false, 0),
/* 159 */	("Additional MM context for SRVCC", false, 0),
/* 160 */	("Additional flags for SRVCC", false, 0),
/* 161 */	("Reserved", false, 0),
/* 162 */	("MDT Configuration", false, 0),
/* 163 */	("Additional Protocol Configuration Options (APCO)", false, 0),
/* 164 */	("Absolute Time of MBMS Data Transfer", false, 0),
/* 165 */	("H(e)NB Information Reporting ", false, 0),
/* 166 */	("IPv4 Configuration Parameters (IP4CP)", false, 0),
/* 167 */	("Change to Report Flags ", false, 0),
/* 168 */	("Action Indication", false, 0),
/* 169 */	("TWAN Identifier", false, 0),
/* 170 */	("ULI Timestamp", false, 0),
/* 171 */	("MBMS Flags", false, 0),
/* 172 */	("RAN/NAS Cause", false, 0),
/* 173 */	("CN Operator Selection Entity", false, 0),
/* 174 */	("Trusted WLAN Mode Indication", false, 0),
/* 175 */	("Node Number", false, 0),
/* 176 */	("Node Identifier", false, 0),
/* 177 */	("Presence Reporting Area Action", false, 0),
/* 178 */	("Presence Reporting Area Information", false, 0),
/* 179 */	("TWAN Identifier Timestamp", false, 0),
/* 180 */	("Overload Control Information", false, 0),
/* 181 */	("Load Control Information", false, 0),
/* 182 */	("Metric", false, 0),
/* 183 */	("Sequence Number", false, 0),
/* 184 */	("APN and Relative Capacity", false, 0),
/* 185 */	("WLAN Offloadability Indication", false, 0),
/* 186 */	("Paging and Service Information", false, 0),
/* 187 */	("Integer Number", false, 0),
/* 188 */	("Millisecond Time Stamp", false, 0),
/* 189 */	("Monitoring Event Information", false, 0),
/* 190 */	("ECGI List", false, 0),
/* 191 */	("Remote UE Context", false, 0),
/* 192 */	("Remote User ID", false, 0),
/* 193 */	("Remote UE IP information", false, 0),
/* 194 */	("CIoT Optimizations Support Indication", false, 0),
/* 195 */	("SCEF PDN Connection", false, 0),
/* 196 */	("Header Compression Configuration", false, 0),
/* 197 */	("Extended Protocol Configuration Options (ePCO)", false, 0),
/* 198 */	("Serving PLMN Rate Control", false, 0),
/* 199 */	("Counter", false, 0),
/* 200 */	("Mapped UE Usage Type", false, 0),
/* 201 */	("Secondary RAT Usage Data Report", false, 0),
/* 202 */	("UP Function Selection Indication Flags", false, 0),
/* 203 */	("Maximum Packet Loss Rate", false, 0),
/* 204 */	("APN Rate Control Status", false, 0),
/* 205 */	("Extended Trace Information", false, 0),
/* 206 */	("Monitoring Event Extension Information", false, 0),
/* 207 */	("Additional RRM Policy Index", false, 0),
/* 208 */	("V2X Context", false, 0),
/* 209 */	("PC5 QoS Parameters", false, 0),
/* 210 */	("Services Authorized", false, 0),
/* 211 */	("Bit Rate", false, 0),
/* 212 */	("PC5 QoS Flow", false, 0),
/* 213 */	("SGi PtP Tunnel Address", false, 0),
/* 214 */	("PGW Change Info", false, 0),
/* 215 */	("PGW FQDN", false, 0),
/* 216 */	("Group Id", false, 0),
/* 217 */	("PSCell ID", false, 0),
/* 218 */	("UP Security Policy", false, 0),
/* 219 */	("Alternative IMSI", false, 0),
/* 220 */	("NF Instance ID", false, 0),
/* 221 */	("Timer in Seconds", false, 0),
/* 222 */	("Unknown", false, 0),
/* 223 */	("Unknown", false, 0),
/* 224 */	("Unknown", false, 0),
/* 225 */	("Unknown", false, 0),
...
/* 252 */	("Unknown", false, 0),
/* 253 */	("Unknown", false, 0),
/* 254 */	("Special IE type for IE Type Extension", false, 0),
/* 255 */	("Private Extension", false, 0)
];